...
function gotresult(error,result){
    ...
    document.getElementById('label').innerHTML = 'Your drawn sketch - ' + drawn_sketch;
    document.getElementById('confidence').innerHTML = 'Accuracy is - ' + Math.round(result[0].confidence * 100) + '%';
}
